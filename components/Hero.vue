<template>
    <div
        class="noise-bg rounded-b-[2rem] p-4 lg:p-0 pt-20 pb-10 lg:py-[6.5rem] 4xl:pb-10 justify-center items-center relative w-[375px] lg:w-full lg:pl-[3.5rem] 3xl:pl-[11rem] 4xl:pl-[14rem]">
