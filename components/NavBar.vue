<template>
  <nav class="fixed top-0 left-0 w-full bg-[#F4EED3] lg:flex justify-between w-3/2 px-20 pt-4 pb-4 z-[99999] rounded-b-[2rem]">
    <img src="/logo.svg" class="my-auto" alt="logo" />

    <div class="flex gap-2">
      <div class="flex text-[#00140F] text-[16px] font-medium px-8 py-1">
        <NuxtLink 
          to="#ourwork" 
      ...
      <NuxtLink to="#contactus">
        <button class="bg-[#FF5F45] font-hind rounded-lg px-4 py-2 text-[#ffffff] font-regular text-[16px] my-auto">
          Contact Us
        </button>
      </NuxtLink>
    </div>
