    ...
    <div class=" items-center 3xl:w-2/3 4xl:w-3/5">
      <div class="flex flex-col lg:flex-row items-center justify-center lg:pl-20 3xl:pl-0  gap-8">
        ...
        <div
          ...
          <ul
            class="text-[#ffffff] list-disc pl-5 lg:pl-8 text-left font-hind text-[16px] font-light leading-[24px] tracking-[0.0075em]">
          ...
          <div class="flex gap-3 mt-8 w-full">
            <NuxtLink to="#contactus" class="w-full lg:w-fit">
              <button
                class="btn-primary font-hind text-[16px] font-normal flex items-center justify-center gap-1 h-10 w-full lg:w-13">
                Contact Us
