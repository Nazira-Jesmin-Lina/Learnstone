              ...
              <div class="flex flex-row gap-12 justify-between w-full lg:mb-[-20px]">
                <div class="flex flex-col-reverse lg:flex-row w-full text-center items-center justify-center gap-8  mt-[1.25rem]">
                  ...
                  <div class="relative w-full 3xl:w-5/6 4xl:pl-6  items-center justify-center ">
                    <img src="/aboutUs_1.svg" class="relative w-full lg:w-[650px] object-contain z-10 lg:top-[-56px]" />
                    <!-- <img src="/public/ellipse3.svg" class="absolute -top-[50px] lg:top-20 -right-[0.5rem] lg:right-[4rem] z-0 w-[176px] lg:w-5/6 " /> -->
                  </div>
                </div>
              </div>
            </div>
            <div class="my-auto text-black pt-10 lg:mt-[-80px] pb-8 lg:pb-10 3xl:pb-10 lg:px-[8.5rem] 3xl:px-[22rem] 4xl:px-[26rem] justify-center items-center w-full">
                <div class="flex flex-col-reverse lg:flex-row-reverse justify-between items-center text-center gap-8">
                  ...
                  <div class="w-full 3xl:w-5/6 3xl:pl-6 4xl:pl-4  relative">
                    <img src="/aboutUs_2.svg" class="w-full lg:w-[650px] 4xl:w-[572px] object-contain z-10 relative" />
